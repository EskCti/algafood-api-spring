...
import com.eskcti.algafoodapi.api.v1.assembliers.RestaurantInputDisassembler;
import com.eskcti.algafoodapi.api.v1.assembliers.RestaurantModelAssemblier;
...
@RestController
@RequestMapping(value = "/v1/restaurants", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
